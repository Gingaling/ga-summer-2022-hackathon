...
<div className="titleBar">
  ...
  <div className="flip-box-inner">
    ...
    <div className="flip-box-back">
      ...
      <p>According to the EPA, municipal solid waste in 2018 was 294.2 million tons, or 4.9 pounds per person per day.</p>
    </div>
  </div>
</div>
 <div className="flip-box" id="two">
  <div className="flip-box-inner">
    ...
    <div className="flip-box-back">
      <h2><em>Did You Know?</em></h2>
      <p>In 2018, about 146.1 million tons of MSW were landfilled. Food was the largest component at about 24 percent.</p>
    </div>
  </div>
</div>
      <div className='pic-cell'>
