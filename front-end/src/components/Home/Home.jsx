        ...
        <button id="respond" onClick={ToggleTabs}>How to Respond</button>
          ...
          <footer className="primary-share-text">Post your surplus item on The LeftOver. Somebody from your community will contact you concerning your surplus item.</footer>
              ...
              <div className="share-card">
                ...
                <footer className="primary-share-text"  id="card-label">3. Share or find your own leftover.</footer>
                <footer className="primary-share-text">Within a short of time, you will have disposed of your left over goods (clothing, appliances, plants, even food).</footer></div>
            </div>
          </section>
